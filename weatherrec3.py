...
# def getWeather(temperature = 9, precipitation = 'clear sky'):
...
# chillysnow= df[df.category.str.contains('blazers|coap = 0
...
# # # #Sort clothing types 
# # blazerscoatsjackets = df[df.category.str.contains("blazers",case=False)]
# # sort_bcj = blazerscoatsjackets.sort_values(by = ['weighted_discount','price'], ascending = [False, True])
# # jeans = df[df.category.str.contains("jeans",case=False)]
# # sort_jeans = jeans.sort_values(by = ['weighted_discount','price'], ascending = [False, True])
# # sweaters = df[df.category.str.contains("shirt",case=False)]
# # sort_sweaters = sweaters.sort_values(by = ['weighted_discount','price'], ascending = [False, True])
# # colddry3 = pd.concat([sort_bcj.head(2), sort_jeans.head(2), sort_sweaters.head(2)])

# #Sort clothes according to desired parameters
# sort_colddry = colddry.sort_values(by= ['category','weighted_discount', 'price'], ascending = [True, False, True])
...
# for categories in sort_colddry['category']: 
#     while categories == categories:
